...
<body class="index-page">
  ...
  <?php require('common/navbar.php');?>
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-5 justify-content-between">
          ...
          <h2><span>Welcome to </span><span class="accent">UFS University</span></h2>
          <p>
          Higher education institution offering a wide range of undergraduate and postgraduate programs across various fields of study. It features a structured academic framework with faculties and departments dedicated to different disciplines, supports research and academic advancement, and provides extensive resources and services for student success. Beyond academics, universities enhance student life through extracurricular activities, career services, and community engagement, fostering a holistic environment for personal and professional growth.
          </p>
          <div class="d-flex">
            <a href="#about">  <button class="applybtn">
              Get Started
          ...
          <div class="col-lg-2 order-2 order-lg-1 d-flex flex-column justify-content-center">
  ...
  <div class="row gy-1">
    ...
    <div class="col-md-6 col-lg-3">
      <div class="head1" style="background-image:url('./assets/img/head1.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <p class="heading">World-Class Education</p>
        <p>Discover a diverse range of programs and courses led by renowned faculty!</p>
      </div>
    </div><!-- End Card 1 -->
    ...
    <div class="col-md-6 col-lg-3">
      <div class="head1" style="background-image:url('./assets/img/head2.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <p class="heading">Vibrant Community</p>
        <p>Experience a dynamic campus life with state-of-the-art facilities!</p>
      </div>
    </div><!-- End Card 2 -->
    ...
    <div class="col-md-6 col-lg-3">
      <div class="head1" style="background-image:url('./assets/img/head3.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <p class="heading">Student Support</p>
        <p>Benefit from robust support services including academic advising!</p>
      </div>
    </div><!-- End Card 3 -->
    ...
    <div class="col-md-6 col-lg-3">
      <div class="head1" style="background-image:url('./assets/img/head4.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <p class="heading">International Experience</p>
        <p>Engage in global learning opportunities with study abroad programs!</p>
      </div>
    </div><!-- End Card 4 -->
  </div>
</div>
